...
public  class WallFactory {
    ...
    private final static int CELL_CIZE = 10;
    ...
    private static Rectangle createWall(int x, int y, int width , int height){
        ...
        Rectangle rectangle =  new Rectangle((x * CELL_CIZE )+ PADDING, y * (CELL_CIZE) + PADDING , width * CELL_CIZE, height * CELL_CIZE);
        rectangle.fill();
        rectangle.draw();
        return rectangle;
