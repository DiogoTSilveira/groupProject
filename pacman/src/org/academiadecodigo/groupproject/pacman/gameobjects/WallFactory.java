...
public class WallFactory {
    ...
    public static void createGameField() {
        Rectangle backGround = new Rectangle(5 * CELL_SIZE + PADDING, 9 * CELL_SIZE + PADDING, 50 * CELL_SIZE, 42 * CELL_SIZE);
        //backGround.setColor(new Color(3,126,141));
        //backGround.setColor(new Color(218, 165, 32));
